...
while 1:
 ...
 if len(sys.argv) == 2:	
    print ("Usage:")
    print ("python3 papershaper.py [g | w | m ] [minutes]")
    ...
    print ("Example: python3 papershaper.py m 30 - refresh randomly from either source every 30 minutes")
    print ("If you specify the first option (g or w or m) then you must specify minutes.")
    print ("Default usage: python3 papershaper.py - refresh randomly from offline/local gallery only every 20 minutes")
    print ("\n")
    print ("For best results, run papershaper.py as a Startup Application or in a start up script.")
    print ("\n")
 ...
 if len(sys.argv) == 3:	
    ...
    if str(sys.argv[1]) == 'g':
        ...
        print ("Invalid option(s).  Type python3 papershaper.py -help for help.")
        exit(1)
